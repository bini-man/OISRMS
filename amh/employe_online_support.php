...
$(document).ready(function(){
 ...
 {
  var modal_content = '<div id="user_dialog_'+to_user_id+'" class="user_dialog" title=" ከ '+to_user_name+' ጋር እየተወያዩ ነው  ">';
  ...
  modal_content+= '<button type="button" name="send_chat" id="'+to_user_id+'" class="btn btn-info send_chat">ላክ</button></div></div>';
