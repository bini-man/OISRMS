...
<button class="accordion"><h3 style="font-family: algerian">1. የኃይል ቁልፍ ኮምፒተር አይጀምርም።</h3></button>
<div class="panel">
...
<button class="accordion"><h3 style="font-family: algerian">2. አንድ መተግበሪያ በቀስታ እየሄደ ነው።</h3></button>
<div class="panel">
<h4>1.መተግበሪያውን ይዝጉ እና እንደገና ይክፈቱ።</h4>
<h4>2.መተግበሪያውን ያዘምኑ። ይህንን ለማድረግ የእገዛ ምናሌውን ጠቅ ያድርጉና ዝመናዎችን ለመፈተሽ አማራጭን ይፈልጉ ፡፡ ይህን አማራጭ ካላገኙ ሌላ ሀሳብ ለመተግበሪያ ዝመናዎች የመስመር ላይ ፍለጋን ማካሄድ ነው።</h4>
</div>
<button class="accordion"><h3 style="font-family: algerian">3. mouth ወይም ቁልፍ ሰሌዳው መስራቱን አቁሟል።</h3></button>
<div class="panel">
