...
th {
  ...
  <div class="container">  
   ...
   <br />  
    ...
    <h3 align="center">MANAGE REQUEST'S</h3><br />  
...
<th onclick="sortTable(3)">BLOCK NUMBER</th>
<th onclick="sortTable(4)">OFFICE NUMBER</th>
<th onclick="sortTable(5)">DATE</th>
<th onclick="sortTable(6)">PROBLEM</th>
<th onclick="sortTable(7)">PRIVOUS APPRED</th>
<th onclick="sortTable(8)">REQUESTER USERNAME</th>
<th onclick="sortTable(9)">FIXED BY</th>
<th onclick="sortTable(10)">STATUS</th>
      </tr>
     </thead>
     <tbody>
     <?php
     $query = "SELECT * FROM requests ORDER BY request_id ASC";
