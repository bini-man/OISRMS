...
th {
  ...
  <div class="container">  
   ...
   <br />  
    ...
    <h3 align="center">MANAGE EXPERT</h3><br />  
...
<th onclick="sortTable(4)">EMAIL</th>
     ...
     <tbody>
     <?php
     $query = "SELECT * FROM expert ORDER BY username DESC";
...
$(document).ready(function(){  
     $('#editable_table').Tabledit({
      url:'actmanageexpert.php',
      columns:{
       identifier:[0, "username"],
       editable:[[1, 'firstname'], [2, 'lasename'], [3,'sex'],  [4,'email']]
      },
      restoreButton:false,
