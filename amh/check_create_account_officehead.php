...
$check="SELECT username FROM officehead where securityno= '$secnumber'";
...
$query = "SELECT * FROM officehead WHERE securityno= '$avilable'";
...
$query = "SELECT * FROM officehead WHERE username= '$user'";
  $user_count = mysqli_query($con,$query);
  if(mysqli_num_rows($user_count) > 0) {
      echo "taken";
  }else{
